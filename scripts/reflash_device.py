...
API_URL = "https://b1rklukfdi.execute-api.eu-central-1.amazonaws.com/setup/provision/get-credentials/"

# get device_id as first argument
device_id = sys.argv[1]
API_URL = API_URL + device_id
...
try:
    ...
    cert = response["credentials"]["certificate"]
